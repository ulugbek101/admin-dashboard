...
async function sendSMSToCheckedPupils(pupilsList, smsText, token) {
	...
	await fetch(`https://shams-school.uz/profiles/send-sms?pupils=${pupilsListUnique}&text=${smsText}`, {
		method: 'GET',
	})
}
...
if (sendSMSTextButton) {
	sendSMSTextButton.addEventListener('click', event => {
		...
		sendSMSToCheckedPupils(checkedPupilsList, smsText.value, csrfToken)
