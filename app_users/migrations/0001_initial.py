# Generated by Django 5.0.1 on 2024-04-22 18:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.CharField(blank=True, choices=[('teacher', "O'qituvchi"), ('admin', 'Admin'), ('superuser', 'Superadmin')], default='teacher', max_length=200, null=True, verbose_name='Xodim statusi')),
                ('profile_picture', models.ImageField(blank=True, default='profile-pictures/user-default.png', null=True, upload_to='profile-pictures/', verbose_name='Profil rasmi')),
